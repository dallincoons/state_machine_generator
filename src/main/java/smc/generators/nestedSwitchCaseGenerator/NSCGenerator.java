...
public class NSCGenerator {
    NSCNode.EnumNode stateEnumNode;
    NSCNode.EnumNode eventEnumNode;
    NSCNode.StatePropertyNode statePropertyNode;
    NSCNode.SwitchCaseNode stateSwitch;
    NSCNode.HandleEventNode handleEventNode;
    NSCNode.EventDelegatorsNode eventDelegatorsNode;
    ...
    private void addEventCases(NSCNode.CaseNode caseNode, OptimizedStateMachine.Transition t ) {
        NSCNode.SwitchCaseNode eventSwitch = new NSCNode.SwitchCaseNode("event");
        caseNode.caseActionNode = eventSwitch;
    ...
    private void addEventCase(NSCNode.SwitchCaseNode caseNode, OptimizedStateMachine.SubTransition st) {
        NSCNode.CaseNode eventCaseNode = new NSCNode.CaseNode("Event", st.event);
        addActions(st, eventCaseNode);
        caseNode.caseNodes.add(eventCaseNode);
    }
